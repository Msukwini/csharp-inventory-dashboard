...
// --- Database Initialization (skip seeding) ---
using (var scope = app.Services.CreateScope())
{
    ...
    while (!success && retries > 0)
    {
        try
        {
            ...
            Console.WriteLine("ℹ️  Seeding skipped – you can add your own products, customers, and orders.");
            success = true;
        }
        catch (Exception ex)
        {
...
Console.WriteLine($"🚀 Inventory Dashboard running on port {appPort}");
